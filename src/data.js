...
function getVan(id){
    return [...vansData].filter(el=>el.id==id)[0]
}


function getHostVans(hostId){
    return [...vansData].filter(el=>el.hostId==hostId)
}


export default vansData
export {getVan,getHostVans}